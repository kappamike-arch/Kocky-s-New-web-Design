      ...
      <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div className="flex flex-col lg:flex-row gap-4 justify-between">
          ...
          <div className="relative flex-1 max-w-md">
            <Wine className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
            <input
              type="text"
                            ...
                            <>
                              <motion.button
                                ...
                                onClick={() => updateStatusMutation.mutate({
                                  id: request.id,
                                  status: 'APPROVED',
                                  notes: 'Mobile bar service approved'
                                })}
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold">Mobile Bar Request Details</h2>
              </div>
