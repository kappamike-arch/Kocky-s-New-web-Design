      ...
      if (data) {
        ...
        contentSections.forEach(section => {
          if (section.id === 'hero_home' && heroData) {
            // Use hero data for hero section
            mappedContent[section.id] = {
              ...section,
              value: {
                title: heroData.title || section.value.title,
                subtitle: heroData.subtitle || section.value.subtitle,
                description: heroData.description || section.value.description,
                image: heroData.backgroundImage || section.value.image,
                video: heroData.backgroundVideo || section.value.video
              }
            };
          } else {
      ...
      <Tabs defaultValue="content" className="space-y-6">
        ...
        <TabsContent value="ordering">
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader>
              <CardTitle className="text-black">Online Ordering Configuration</CardTitle>
            </CardHeader>
        ...
        <TabsContent value="email">
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader>
              <CardTitle className="text-black">Email & Payment Configuration</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
