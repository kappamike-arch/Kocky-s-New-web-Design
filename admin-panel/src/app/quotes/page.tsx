...
export default function QuotesPage() {
  ...
  const updateQuoteStatus = async (quoteId: string, status: string) => {
    try {
      const response = await fetch(`https://api.staging.kockys.com/api/quotes/${quoteId}/status`, {
        method: 'PUT',
  ...
  const sendQuote = async (quoteId: string) => {
    try {
      const response = await fetch(`https://api.staging.kockys.com/api/quotes/${quoteId}/send`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
  ...
  const downloadPDF = async (quoteId: string, quoteNumber: string) => {
    try {
      const response = await fetch(`https://api.staging.kockys.com/api/quotes/${quoteId}/pdf`);
  ...
  const emailQuotePDF = async (quoteId: string) => {
    try {
      const response = await fetch(`https://api.staging.kockys.com/api/quotes/${quoteId}/pdf/email`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          message: 'Thank you for your inquiry. Please find attached our quote for your event.',
  ...
  const deleteQuote = async (quoteId: string) => {
    ...
    try {
      const response = await fetch(`https://api.staging.kockys.com/api/quotes/${quoteId}`, {
        method: 'DELETE',
      });
