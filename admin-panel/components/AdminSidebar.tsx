...
import { 
  ...
  Truck, Wine, BarChart, Settings, LogOut, ChevronRight, ChevronDown,
  Image, Type, Briefcase, CalendarDays, FileText, Package, 
  ImageIcon, X, Menu, ChevronLeft, Layout, Coffee, Utensils, Star, Mail, Shield
} from 'lucide-react';
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { name: 'Generate Quote', path: '/quotes/generate', icon: FileText },
    ...
    { 
      ...
      children: [
        ...
        { name: 'Email Settings', path: '/email-settings', icon: Mail },
        { name: 'Microsoft 365 Email', path: '/email-oauth', icon: Shield },
      ]
    },
  ];
